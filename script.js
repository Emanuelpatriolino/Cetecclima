...
const mensagem = `Olá, gostaria de agendar uma visita para ${ procedimento}. Meu nome é ${ nome}, moro na ${ endereço}, meu whatsApp é ${ tel}, fico no aguardo! :) `;

 const phonesalao = "+5585992209416";
